...
| Name               | yew                                                                                             | stdweb                                                                                         | percy                                                                                            | dodrio                                                                                           | seed                                                                                               | draco                                                                                                 | squark                                                                                          | willow                                                                                            | smithy                                                                                             | dominator                                                                                                 |
| ---                | ---                                                                                             | ---                                                                                            | ---                                                                                              | ---                                                                                              | ---                                                                                                | ---                                                                                                   | ---                                                                                             | ---                                                                                               | ---                                                                                                | ---                                                                                                       |
...
| **Base framework** | wasm-bindgen (or stdweb)                                                                        | -                                                                                              | wasm-bindgen                                                                                     | wasm-bindgen                                                                                     | wasm-bindgen                                                                                       | wasm-bindgen                                                                                          | wasm-bindgen                                                                                    | wasm-bindgen                                                                                      | wasm-bindgen                                                                                       | wasm-bindgen                                                                                              |
| **Virtual DOM**    | yes                                                                                             | ?                                                                                              | yes                                                                                              | yes                                                                                              | yes                                                                                                | yes                                                                                                   | yes                                                                                             | ?                                                                                                 | yes                                                                                                | **no**                                                                                                    |
